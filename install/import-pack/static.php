...
if( ! function_exists( 'awakenur_import_pack_scripts' ) ) {
    /**
     * Import pack load scripts
     *
     */
    function awakenur_import_pack_scripts() {
        ...
        wp_localize_script( 'import-pack-js', 'import_pack_php_data', [
             ...
             * security
             */
            'template_nonce'    => wp_create_nonce( 'awakenur_template_nonce' ),
            'callback_nonce'    => wp_create_nonce( 'awakenur_callback_nonce' ),
            'download_package_nonce'  => wp_create_nonce( 'awakenur_download_package_nonce' ),
            'extract_package_nonce'  => wp_create_nonce( 'awakenur_extract_package_nonce' ),
            'restore_data_nonce'  => wp_create_nonce( 'awakenur_restore_data_nonce' ),
            'backup_site_nonce'  => wp_create_nonce( 'awakenur_backup_site_nonce' ),
    ...
    add_action( 'admin_enqueue_scripts', 'awakenur_import_pack_scripts' );
}
