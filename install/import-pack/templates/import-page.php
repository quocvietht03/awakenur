...
<div id="Import_Pack_Container">
    ...
    <h1 class="heading-page"><?php echo apply_filters( 'awakenur/import_pack/heading_text', __( 'Awakenur Import Package Demo.', 'awakenur' ) ); ?></h1>

    <?php do_action( 'awakenur/import_pack/before' ); ?>
    ...
    <div class="ip-footer">
        <?php echo apply_filters( 'awakenur/import_pack/footer_text', __( 'Power by Beplus, Thank you creating with Awakenur.', 'awakenur' ) ); ?>
    </div>

    <?php do_action( 'awakenur/import_pack/after' ); ?>
...
<div id="Import_Pack_Modal" class="ip-modal-container">
    <div class="ip-modal">
        <div class="ip-modal-header">
            <a href="javascript:" class="__close" title="<?php echo esc_attr( 'close', 'awakenur' ); ?>">
