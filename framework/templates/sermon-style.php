...
$sermon_archive_url = get_post_type_archive_link('sermon');
$date_time = '';
if (!empty($date)) {
  $date_time .= $date;
}
...
<article <?php post_class('bt-post'); ?>>
  ...
  <div class="bt-post--content">
    ...
    if (!empty($terms)) {
      ...
      echo '<div class="bt-post--term"><a href="'.$sermon_archive_url.'?sm_topic=' . $term->slug . '"><svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="bt-post--action">
      <?php if (!empty($audio_source)) { ?>
        <a class="bt-play-audio" href="#" data-id="<?php echo esc_attr($post_id); ?>"><svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
