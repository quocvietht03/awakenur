<?php
namespace AwakenurElementorWidgets\Widgets\OrbitCircle;
...
class Widget_OrbitCircle extends Widget_Base {
	...
	public function get_title() {
		return __( 'Orbit Circle', 'awakenur' );
	}
