...
namespace AwakenurElementorWidgets\Widgets\MobileMenu;
...
class Widget_MobileMenu extends Widget_Base
{
	...
	{
		return __('Mobile Menu', 'awakenur');
	}
	...
	protected function register_content_section_controls()
	{
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				'menu',
				[
					'label' => esc_html__( 'Menu', 'awakenur' ),
					...
					'description' => sprintf(
						...
						esc_html__( 'Go to the %1$sMenus screen%2$s to manage your menus.', 'awakenur' ),
			...
			$this->add_control(
				...
				[
					...
					'alert_type' => 'info',
					'heading' => esc_html__( 'There are no menus in your site.', 'awakenur' ),
					'content' => sprintf(
						/* translators: 1: Link opening tag, 2: Link closing tag. */
						esc_html__( 'Go to the %1$sMenus screen%2$s to create one.', 'awakenur' ),
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Main Menu', 'awakenur'),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Normal', 'awakenur' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Text Color', 'awakenur' ),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Hover', 'awakenur' ),
			]
		);
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Active', 'awakenur' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Vertical Padding', 'awakenur' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Toggle Offset', 'awakenur' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Sub Menu', 'awakenur'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Additional Options', 'awakenur'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'heading_toggle_menu',
			[
				'label' => esc_html__( 'Toggle Menu', 'awakenur' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Divider Menu', 'awakenur' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'divider_menu_style',
			[
				'label' => esc_html__( 'Style', 'awakenur' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'none' => esc_html__( 'None', 'awakenur' ),
					'solid' => esc_html__( 'Solid', 'awakenur' ),
					'double' => esc_html__( 'Double', 'awakenur' ),
					'dotted' => esc_html__( 'Dotted', 'awakenur' ),
					'dashed' => esc_html__( 'Dashed', 'awakenur' ),
				],
				'default' => 'solid',
				'selectors' => [
		...
		$this->add_control(
			'divider_menu_weight',
			[
				'label' => esc_html__( 'Width', 'awakenur' ),
				'type' => Controls_Manager::SLIDER,
