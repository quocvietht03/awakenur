...
namespace AwakenurElementorWidgets\Widgets\HeadingAnimation;
...
class Widget_HeadingAnimation extends Widget_Base
{
	...
	{
		return __('Heading Animation', 'awakenur');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'animation_text',
			[
				'label'       => esc_html__('Heading Animation', 'awakenur'),
				'type'        => Controls_Manager::TEXTAREA,
				'label_block' => true,
				'default'     => esc_html__('Animation', 'awakenur'),
			]
		);
		...
		$this->add_control(
			'link_heading',
			[
				'label'       => esc_html__('Link', 'awakenur'),
		...
		$this->add_control(
			'entrance_animation',
			[
				'label' => esc_html__( 'Entrance Animation', 'awakenur' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => [
					'none' => esc_html__( 'None', 'awakenur' ),
					'bt-animation-right' => esc_html__( 'Fade In Right', 'awakenur' ),
					'bt-animation-left' => esc_html__( 'Fade In Left', 'awakenur' ),
					'bt-animation-up' => esc_html__( 'Fade In Up', 'awakenur' ),
					'bt-animation-down' => esc_html__( 'Fade In Down', 'awakenur' ),
					'bt-animation-zoom' => esc_html__( 'Zoom In', 'awakenur' ),
				],
			]
		);
		$this->add_responsive_control(
			'animation_delay',
			[
				'label' => __('Animation Delay (ms)', 'awakenur'),
